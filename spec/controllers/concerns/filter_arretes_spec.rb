...
RSpec.describe 'date_match' do
  it 'returns true if date is not used in parametrization.' do
    date_parameter_descriptor = { 'is_used' => false, 'known_value' => nil, 'left_value' => nil, 'right_value' => nil }
  ...
  it 'returns true if version is the unknown date version and classement date is nil.' do
    date_parameter_descriptor = { 'is_used' => true, 'known_value' => false, 'left_value' => nil, 'right_value' => nil }
  ...
  it 'returns false if version is not the unknown date version and classement date is nil.' do
    date_parameter_descriptor = { 'is_used' => true, 'known_value' => true, 'left_value' => '2020-01-01',
                                  'right_value' => nil }
  ...
  it 'returns false if version is not the unknown date version and classement date is not in range.' do
    date_parameter_descriptor = { 'is_used' => true, 'known_value' => true, 'left_value' => '2022-01-01',
                                  'right_value' => nil }
