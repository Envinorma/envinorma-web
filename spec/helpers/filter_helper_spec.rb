...
RSpec.describe '#sort_and_group' do
  it 'sorts prescriptions by creation date when different AM.' do
    ...
    prescription2 = Prescription.new(
      ...
      rank: '0',
      user_id: 0,
      created_at: '2020/01/01'.to_date
    )
    prescriptions = [prescription1, prescription2]
    output_prescriptions = FilterHelper.sort_and_group(prescriptions).values.map(&:values).flatten
  ...
  it 'groups prescriptions by text then reference, sorted by rank.' do
    ...
    prescription3 = Prescription.new(
      reference: 'ref',
      content: '',
      alinea_id: '3',
      from_am_id: 'am-id',
      ...
      rank: '1.3.2',
      user_id: 0,
      created_at: '2020/01/03'.to_date
    )
    prescription4 = Prescription.new(
      reference: 'ref-2',
      content: '',
      alinea_id: '3',
      from_am_id: 'am-id',
    ...
    output_prescriptions = FilterHelper.sort_and_group(prescriptions)
